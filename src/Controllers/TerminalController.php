...
class TerminalController extends Controller
{
    public function artisan(Content $content)
    {
        ...
        $content->row(view('open-developer-helpers::artisan', ['commands' => $this->organizedCommands()]));
    ...
    public function database(Content $content)
    {
        ...
        $content->row(view('open-developer-helpers::database', ['connections' => $this->connections()]));
