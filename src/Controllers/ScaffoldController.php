...
namespace OpenDeveloper\Developer\Helpers\Controllers;
...
use OpenDeveloper\Developer\Helpers\Scaffold\MigrationCreator;
use OpenDeveloper\Developer\Helpers\Scaffold\ModelCreator;
...
class ScaffoldController extends Controller
{
    public function index(Content $content)
    {
        ...
        $content->row(view('open-developer-helpers::scaffold', compact('dbTypes', 'action')));
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (in_array('controller', $request->get('create'))) {
                Artisan::call('developer:controller \\\\'.addslashes($request->get('model_name')).' --name='.$this->getControllerName($request->get('controller_name')));
